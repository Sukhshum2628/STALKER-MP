...
| **008** | **Snapshot System (immutable snapshots)** | 🚧 **In progress** — Step 10 / 14 |
...
- **361 / 361 build tests passing** (Release x64) on **GCC** and **MSVC.** **Game testing has not started yet**.
