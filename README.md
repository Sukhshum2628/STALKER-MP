...
| **008** | **Snapshot System (immutable snapshots)** | 🚧 **In progress** — Step 2 / 14 |
...
- **Sprint-008:** value types (Step 1) and configuration (Step 2) implemented and verified; steps 3–14 (immutable snapshot, pool, capture seam, builder, queue, manager, engine adapter, wiring, diagnostics, hardening, integration, closure) remain.
...
- **321 / 321 tests passing** (Release x64) on **GCC** and **MSVC**.
