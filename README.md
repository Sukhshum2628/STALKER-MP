...
| **013** | **Lua Integration** | 🚧 **In progress** — Batch 9 / 11 (Steps 01–16 of 18) |
...
- **731 / 731 build tests passing** (Release x64) on **GCC** and **MSVC** (675 Sprint-012 baseline + 56 Sprint-013 through Batch-9). **Game testing has not started yet**.
