...
| 012 | Save/Load System (save format, world serialization, load pipeline) | ⏳ Planned |
...
- **599 / 599 build tests passing** (Release x64) on **GCC** and **MSVC.** **Game testing has not started yet**.
