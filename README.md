...
| **008** | **Snapshot System (immutable snapshots)** | 🚧 **In progress** — Step 9 / 14 |
...
- **360 / 360 build tests passing** (Release x64) on **GCC** and **MSVC.** **Game testing has not started yet**.
