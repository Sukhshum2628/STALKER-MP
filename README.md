...
| **008** | **Snapshot System (immutable snapshots)** | 🚧 **In progress** — Step 11 / 14 |
...
- **367 / 367 build tests passing** (Release x64) on **GCC** and **MSVC.** **Game testing has not started yet**.
